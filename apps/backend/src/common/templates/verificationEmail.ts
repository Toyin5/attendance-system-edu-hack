...
export default function verification(data: verificationData) {
  return `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        ...
        <main>
          <p>Hi ${data.name}</p>
          <p>We just need to verify your email address before you can access <strong>Attendance System</strong>.</p>
          <p>This is your token for verificattion</p>
          <div class="token">
            ${data.token}
          </div>
